        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            <label class="col-lg-3 col-md-5 col-sm-10 col-form-label">Nombre:</label>
                ...
                <div class="mb-3 row">
                    <label for="opcionesDesplegable" class="col-lg-2 col-md-6 col-sm-12 col-form-label">Selecciona una
                        Familia:</label>
                    <div class="col-lg-10 col-md-6 col-sm-12">
